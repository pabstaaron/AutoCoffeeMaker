...
\frame{\includegraphics[width=0.4\columnwidth]{wifi.png}}
...
\begin{figure}[!ht]
\centering
\frame{\includegraphics[width=0.4\columnwidth]{loginStretch.png}}
\frame{\includegraphics[width=0.4\columnwidth]{brewStretch.png}}
\frame{\includegraphics[width=0.4\columnwidth]{menu.png}}
