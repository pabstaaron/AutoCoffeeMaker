...
% TODO Not sure a java.net callout is necessary
...
% Not sure this is something we want to do..
% I don't want to be in the business of trying to set up a PI as an AP
...
\par %this section is for the brewing activity of the application
