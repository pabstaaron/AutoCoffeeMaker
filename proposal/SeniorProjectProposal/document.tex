...
\begin{itemize}
\item Setup a WildFly(JBoss) web server that is capable of receiving and sending REST requests.
\item Establish API for communicating with android application (decide on communication format, i.e. xml or json)
\item Convert REST data into java objects. 
\item Develop a set of MyBatis mappers that can convert Java objects to SQL inserts and vice versa.
